    ...
    <>
      <div className="container p-3">
        ...
        >
          ...
          <div className="offcanvas-body bg-light text-dark">
            <div className="d-flex flex-column justify-content-between h-100">
                ...
                {showEmpty ? (
                  ...
                  products.map((product, i) => (
                    ...
                    >
                      ...
                      <img
                        className="w-25 btn h-auto"
                        src={product.image}
                        alt=""
                      />
                      <h6 className="mt-3">{product.title.length > 20 ? product.title.slice(0,20) + '.....': product.title}</h6>
              ...
              {products.length !== 0 && (
                <div  className="d-flex h-50 w-100 justify-content-between flex-column fw-bold">
                  <div className="h-75 w-100 bg-light border  mb-2" >
